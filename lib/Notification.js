...
var Notification = function (alert) {
     ...
     *
     * badge (integer): The number to display as the badge
     ...
     * action slider. ,
     * titleLocArgs (Array[string]): Variable string values
     * to appear in place of the format specifiers in title-loc-key. ,
     * locArgs (Array[string]): Variable string values to
     ...
     * @return the NotificationBuilder object so that calls can be chained.
     */
    this.setApnsSettings = function (apns) {
     ...
     * timeToLive (integer):  This parameter specifies how
     ...
     * have following keys {{@code} {@liknk GcmLED} ledArgb; Integer ledOnMs; String
     * ledOffMs;}
    ...
    this.setGcmSettings = function (gcm) {
...
Notification.GcmStyleTypes = {
    ...
    BIGTEST_NOTIFICATION: "BIGTEST_NOTIFICATION",
