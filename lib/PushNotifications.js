...
/**
 *  Used to send Push notifications via a IBM Cloud Push Notifications service with APIKey.
 *  @module PushNotificationsWithApiKey
 ...
 *  @param {string} apiKeyId          The apiKeyId required for Push Notifications service authorization.
 */
var PushNotificationsWithApiKey = function (bluemixRegion, tenantId, apiKeyId) {
    ...
    if (PushNotifications.overrideServerHost != null) {
        ...
        if(bluemixRegion === ".jp-tok.bluemix.net") {
            bluemixHost = "https://jp-tok.imfpush.cloud.ibm.com";
        } else {
