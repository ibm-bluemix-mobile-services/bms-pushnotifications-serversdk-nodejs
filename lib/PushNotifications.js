...
module.exports = {
    ...
    Gcm: require('./Gcm.js'),
    ChromeAppExt : require('./ChromeAppExt.js'),
    ChromeWeb: require('./ChromeWeb.js'),
    FirefoxWeb: require('./FirefoxWeb.js'),
    SafariWeb: require('./SafariWeb.js'),
    GcmLights: require('./GcmLights.js'),
    GcmStyle: require('./GcmStyle.js'),
    Settings: require('./Settings.js'),
    Target: require('./Target.js'),
    Mesage: require('./Message.js')
};