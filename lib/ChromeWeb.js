...
/**
 * ChromeWeb object that specifies the settings specific to the ChromeWeb browser.
 * @module ChromeWeb
 */
var ChromeWeb = {
     ...
     * @return The Builder object for calls to be linked.
     * @method module:ChromeWeb#iconUrl  
     */
    iconUrl(iconUrl) {
     ...
     * @return The Builder object for calls to be linked.
     * @method module:ChromeWeb#timeToLive  
     */
     ...
     * @return The Builder object for calls to be linked.
     * @method module:ChromeWeb#payload  
     */
    payload(payload) {
    ...
    /**
    * Builds ChromeWeb values.
    * @method module:ChromeWeb#build 
    */
    build() {
        return this.json;
    }
